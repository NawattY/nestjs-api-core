...
describe('MerchantService findById', () => {
  ...
  it('should be ok', async () => {
    ...
    const result = await merchantService.findById(fakeRequest.merchantId);
  ...
  it('should throw exception if banner not found', async () => {
    ...
    try {
      await merchantService.findById(fakeRequest.merchantId);
    } catch (err) {
